...
import { Copy, Eye, GripVertical, LayoutDashboard, Link2, Loader2, Plus, Save, Send, Smartphone, Star, Trash2 } from "lucide-react";
...
export function FunctionalBuilder() {
  ...
  }, [activeFormId, activeSlug, allowAnonymous, description, draftLoaded, editFormId, expiresAt, fields, selectedTemplate, shareUrl, theme, title, visibility]);
          ...
          <aside className="border-t border-emerald-900/10 p-4 dark:border-white/10 lg:border-l lg:border-t-0">
            ...
            <div className="space-y-4">
              ...
              <Button className="w-full bg-emerald-300 text-emerald-950 hover:bg-emerald-200" disabled={isBusy} onClick={() => syncForm({ publish: true })}>
                ...
                {visibility === "public" ? "Publish and view Explore" : "Publish and view dashboard"}
              </Button>
